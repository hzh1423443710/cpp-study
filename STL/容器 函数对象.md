...
cout << negate<int>{}(10) << endl;			//相反数
cout << multiplies<int>{}(5,5) << endl;		//×
cout << divides<int>{}(10, 5) << endl;		//÷
cout << modulus<int>{}(10, 3) << endl;		//%
//关系类
cout << less<>{}(1, 2) << endl;				//<
cout << less_equal<>{}(2,2) << endl;		//<=
cout << greater<>{}(3, 2) << endl;			//>
cout << greater_equal<>{}(3, 2) << endl;	//>=
cout << not_equal_to<>{}(1, 2) << endl;		//!=
cout << equal_to<>{}(1, 1) << endl;			//==
//逻辑类
cout << logical_or<>{}(1, 0) << endl;		// ||
cout << logical_and<>{}(1, 0) << endl;		// &&
cout << logical_not<>{}(0) << endl;			// !
//位运算	
cout << bit_and<>{}(15, 14) << endl;		// &
cout << bit_or<>{}(15, 0) << endl;			// |
cout << bit_xor<>{}(15, 0) << endl;			// ^
cout << bit_not<>{}((char)255) << endl;		// ~
```
...
* 拓展函数的参数接口
* 操作函数指针,让函数指针能够适应回调函数参数
* 返回一个对应类型的函数包装器function<>
